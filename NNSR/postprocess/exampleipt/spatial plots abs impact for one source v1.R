...
## This R script makes multipanel plots of MDA8 O3 for the example source #1 used in the O3 IPT Appendix B illustrative example 
...
pdf(file="/Users/kirkbaker/Documents/o3ipt/pics/spatial_source1_part1.pdf",width=12,height=12)
#par(mfrow=c(3,3))
...
datavar.array.plot[baseline.array < 60 ] <- -1.
datavar.array.plot[datavar.array.plot > maxval ] <- maxval
image.plot(x.proj.12,y.proj.12,datavar.array.plot,xlab="",ylab="",zlim=c(0,maxval),axes=T,col=my.colors(50),main="MDA8 O3",cex.main=1.25,cex.axis=0.75,legend.args=list(text="ppb",col="black",cex=0.66,side=1,line=0.4))
...
pdf(file="/Users/kirkbaker/Documents/o3ipt/pics/spatial_source1_part2.pdf",width=12,height=12)
#par(mfrow=c(3,3))
par(mfrow=c(4,4), mar=c(3,3,3.5,3), oma=c(0,0,0,1))
